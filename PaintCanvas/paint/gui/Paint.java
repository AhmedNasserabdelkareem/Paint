		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					...
					lblShapes.setBounds(1746, 0, 142, 73);
					lblShapes.setFont(new Font("Tahoma", Font.BOLD, 24));
					lblShapes.setForeground(Color.CYAN);
					...
					FILLCOLOR.setBounds(1363, 13, 47, 36);
					panel.add(FILLCOLOR);
					...
					SHAPES.setBounds(1743, 106, 159, 22);
